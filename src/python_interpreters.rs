...
// Python 3.10
Python3Impl!(v3_10_9);
PythonCommonImpl!(v3_10_9, PyUnicodeObject);

impl CodeObject for v3_10_9::PyCodeObject {
    type BytesObject = v3_10_9::PyBytesObject;
    type StringObject = v3_10_9::PyUnicodeObject;
    type TupleObject = v3_10_9::PyTupleObject;
...
// Python 3.9
PythonCommonImpl!(v3_9_15, PyUnicodeObject);
PythonCodeObjectImpl!(v3_9_15, PyBytesObject, PyUnicodeObject);
Python3Impl!(v3_9_15);

// Python 3.8
PythonCommonImpl!(v3_8_15, PyUnicodeObject);
PythonCodeObjectImpl!(v3_8_15, PyBytesObject, PyUnicodeObject);
Python3Impl!(v3_8_15);

// Python 3.7
PythonCommonImpl!(v3_7_15, PyUnicodeObject);
PythonCodeObjectImpl!(v3_7_15, PyBytesObject, PyUnicodeObject);
Python3Impl!(v3_7_15);

// Python 3.6
PythonCommonImpl!(v3_6_15, PyUnicodeObject);
PythonCodeObjectImpl!(v3_6_15, PyBytesObject, PyUnicodeObject);
Python3Impl!(v3_6_15);
